...
<body>
    ...
    <div class="container">
        ...
        <a href="form-menu.php" class="btn btn-primary mb-3">Tambah Menu Baru</a>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                <td ><img src='" . htmlspecialchars($gambarPath, ENT_QUOTES) . "' class='img-thumbnail' alt='Gambar'></td>
                                <td>" . htmlspecialchars($row['nama'], ENT_QUOTES) . "</td>
                                <td>" . htmlspecialchars($row['deskripsi'], ENT_QUOTES) . "</td>
                                <td>Rp. " . number_format($row['harga'], 2, ',', '.') . "</td>
                                <td>" . htmlspecialchars($row['bahan'], ENT_QUOTES) . "</td>
                                <td>
                                    <a href='edit-menu.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Edit</a>
                                    <a href='delete-menu.php?id=" . $row['id'] . "' onclick='return confirm(\"Yakin ingin menghapus data ini?\");' class='btn btn-danger btn-sm'>Hapus</a>
                                </td>
                            </tr>";
                    }
                } else {
